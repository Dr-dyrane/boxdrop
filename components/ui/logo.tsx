...
interface LogoProps {
    className?: string;
    /** Whether to force a specific color or respect theme currentColor */
    fixed?: boolean;
}

/* ─────────────────────────────────────────────────────
   LOGO COMPONENT
   Universal brand asset. 
   Uses currentColor to adapt to Dark/Light themes.
   ───────────────────────────────────────────────────── */

export function Logo({ className, fixed = false }: LogoProps) {
    return (
        <svg
            viewBox="0 0 24 24"
            fill="none"
